...
[![Total Portfolio Value](https://img.shields.io/badge/Portfolio_Value-₪178%2C846-0284c7?style=for-the-badge&logo=cashapp)](https://almog787.github.io/My-new-stock-trucker/)
[![YTD Monthly Income](https://img.shields.io/badge/Monthly_Income-+₪2%2C155%2Fmo-4338ca?style=for-the-badge)](https://almog787.github.io/My-new-stock-trucker/)
[![Dividends 12M](https://img.shields.io/badge/Dividends_12M-₪827-059669?style=for-the-badge)](https://almog787.github.io/My-new-stock-trucker/)
...
### 🕒 סטטוס עדכון
- **מועד עדכון אחרון:** `25/08/2026 20:30`
- **שער חליפין רציף (USD/ILS כולל מרווח ברוקר):** `₪2.981`
...
| :--- | :--- | :--- | :--- |
| **שווי נוכחי כולל (Current Value)** | `$59,997` | `₪178,846` | שווי השוק הנוכחי של כלל הנכסים |
| **עלות השקעה כוללת (Cost Basis)** | `$42,871` | `₪127,795` | סך הקרן המושקעת המקורית |
| **רווח/הפסד כולל ברוטו (Total P&L Gross)** | `+$17,126` | `+₪51,051` | **+39.95%** תשואה על הקרן |
| **מס רווחי הון צפוי (Israeli Tax 25%)** | `-$4,713` | `-₪14,048` | מס ריאלי משוער למימוש |
| **רווח כולל נטו (Total P&L Net)** | `+$12,414` | `+₪37,004` | **+28.96%** נטו לאחר מס |
| **שינוי יומי (Daily Change)** | `+$296` | `+₪881` | **+0.50%** |

### 💵 תזרים והכנסות שוטפות (Cash Flow & Income Generation)
| סוג הכנסה / Metric | ערך ברוטו | ערך נטו (לאחר 25% מס) | תיאור |
| :--- | :--- | :--- | :--- |
| **תוספת חודשית ממוצעת (YTD Monthly)** | `+₪2,155/חודש` (+$723) | `+₪1,617/חודש` (+$542) | תרומת התיק השנתית כהכנסה פאסיבית חודשית |
| **דיבידנדים בפועל ב-12 חודשים (12M)** | `₪827` ($278) | `₪620` ($208) | **0.46%** תשואת דיבידנד שנתית לתיק |
| **סך דיבידנדים מצטבר היסטורי (All-Time)** | `₪2,458` ($825) | `₪1,843` ($618) | סה"כ 67 אירועי חלוקה רשמיים שהתקבלו |
...
| :--- | :---: | :---: | :---: | :---: | :---: | :---: | :---: | :---: |
| **GOOGL** <br><sub>Alphabet (Google)</sub> | 48 | $187.99 | $346.96 | $16,654 <br><sub>₪49,644</sub> | 🟢 +84.56% <br><sub>₪22,746</sub> | ₪17,059 | 27.8% | $40.8 ($30.6 נטו) |
| **ASML** <br><sub>ASML Holding</sub> | 4 | $934.51 | $1744.16 | $6,977 <br><sub>₪20,797</sub> | 🟢 +86.64% <br><sub>₪9,654</sub> | ₪7,240 | 11.6% | $36.2 ($27.2 נטו) |
| **XOM** <br><sub>Exxon Mobil</sub> | 2 | $126.08 | $160.64 | $321 <br><sub>₪958</sub> | 🟢 +27.41% <br><sub>₪206</sub> | ₪155 | 0.5% | $8.2 ($6.2 נטו) |
| **NVDA** <br><sub>NVIDIA Corp</sub> | 57 | $148.62 | $213.05 | $12,144 <br><sub>₪36,200</sub> | 🟢 +43.35% <br><sub>₪10,947</sub> | ₪8,211 | 20.2% | $16.0 ($12.0 נטו) |
| **TSLA** <br><sub>Tesla Inc</sub> | 20 | $436.45 | $350.25 | $7,005 <br><sub>₪20,881</sub> | 🔴 -19.75% <br><sub>₪-5,139</sub> | ₪-5,139 | 11.7% | — |
| **VOO** <br><sub>Vanguard S&P 500</sub> | 24 | $527.38 | $704.02 | $16,896 <br><sub>₪50,367</sub> | 🟢 +33.49% <br><sub>₪12,637</sub> | ₪9,478 | 28.2% | $176.3 ($132.2 נטו) |
